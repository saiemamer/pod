...
# The manifest is source -> stg_orders -> orders -> order_summary, so the lineage canvas,
...
{"metadata": {"dbt_version": "1.9.0", "generated_at": "2026-09-07T14:00:00Z", "project_name": "demo"},
 ...
 "parent_map": {"model.demo.orders": ["model.demo.stg_orders"], "model.demo.stg_orders": ["source.demo.raw.orders"], "model.demo.order_summary": ["model.demo.orders"], "source.demo.raw.orders": []},
 "child_map": {"model.demo.stg_orders": ["model.demo.orders"], "model.demo.orders": ["model.demo.order_summary"], "source.demo.raw.orders": ["model.demo.stg_orders"], "model.demo.order_summary": []}}
EOF
  exit 0 ;;
