import { POD_RELEASE_REPO } from './brand'
...
export const HOURLY_RELEASE_REPO = POD_RELEASE_REPO
export const DAILY_RELEASE_REPO = POD_RELEASE_REPO
export const ADHOC_RELEASE_REPO = POD_RELEASE_REPO
export const MAIN_RELEASE_REPO = POD_RELEASE_REPO
