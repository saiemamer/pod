...
export function renderInitiativeMarkdown(
  ...
  return [
    ...
    'orca orchestration task-create --run <run> --title "<part>" [--deps <task>]',
    'orca orchestration worker-start --task <task> --worktree new-top-level --repo id:<repo> --name <slug>-<part> --agent claude',
